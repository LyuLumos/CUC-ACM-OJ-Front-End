    ...
    <Menu theme="light" mode="horizontal" @on-select="handleRoute" :active-name="activeMenu" :class="oj-menu">
      ...
      <Dropdown @on-click="switchChange" class="ivu-menu-submenu">
        ...
        <DropdownMenu slot="list">
          <DropdownItem name="1"><Icon type="ios-browsers" color="#2d8cf0" />&emsp;蓝</DropdownItem>
          <DropdownItem name="2"><Icon type="ios-browsers" color="#f58f98" />&emsp;粉</DropdownItem>
	        <DropdownItem name="4"><Icon type="ios-browsers" color="#d63031" />&emsp;红</DropdownItem>
		      <DropdownItem name="5"><Icon type="ios-browsers" color="#00b894" />&emsp;绿</DropdownItem>
          <DropdownItem name="3"><Icon type="ios-browsers" color="#673AB7" />&emsp;紫</DropdownItem>
        </DropdownMenu>
      </Dropdown>
      ...
      <template v-else>
        <Dropdown class="drop-menu" @on-click="handleRoute" placement="bottom" trigger="click">
          <Poptip trigger="hover" :title="`当前 ${ profile.grade } 级`" :content="`当前积分： ${ profile.experience } `" width="200px">
